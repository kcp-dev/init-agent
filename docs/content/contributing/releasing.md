...
The guide describes how to release a new version of the init-agent.
...
1. Navigate to https://github.com/kcp-dev/init-agent/actions/workflows/docs-gen-and-push.yaml
