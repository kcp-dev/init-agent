...
import (
	...
	initializationinformers "github.com/kcp-dev/init-agent/sdk/informers/externalversions/initialization"
...
type SharedInformerFactory interface {
	...
	Initialization() initializationinformers.ClusterInterface
}

func (f *sharedInformerFactory) Initialization() initializationinformers.ClusterInterface {
	return initializationinformers.New(f, f.tweakListOptions)
}
...
type SharedScopedInformerFactory interface {
	...
	Initialization() initializationinformers.Interface
}

func (f *sharedScopedInformerFactory) Initialization() initializationinformers.Interface {
	return initializationinformers.NewScoped(f, f.namespace, f.tweakListOptions)
}
