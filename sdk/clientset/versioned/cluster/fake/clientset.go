...
import (
	...
	client "github.com/kcp-dev/init-agent/sdk/clientset/versioned"
	kcpclient "github.com/kcp-dev/init-agent/sdk/clientset/versioned/cluster"
	kcpinitializationv1alpha1 "github.com/kcp-dev/init-agent/sdk/clientset/versioned/cluster/typed/initialization/v1alpha1"
	fakeinitializationv1alpha1 "github.com/kcp-dev/init-agent/sdk/clientset/versioned/cluster/typed/initialization/v1alpha1/fake"
	clientscheme "github.com/kcp-dev/init-agent/sdk/clientset/versioned/scheme"
...
// InitializationV1alpha1 retrieves the InitializationV1alpha1ClusterClient.
func (c *ClusterClientset) InitializationV1alpha1() kcpinitializationv1alpha1.InitializationV1alpha1ClusterInterface {
	return &fakeinitializationv1alpha1.InitializationV1alpha1ClusterClient{Fake: c.Fake}
}
...
func (c *Clientset) InitializationV1alpha1() initializationv1alpha1.InitializationV1alpha1Interface {
	return &fakeinitializationv1alpha1.InitializationV1alpha1Client{Fake: c.Fake, ClusterPath: c.clusterPath}
}
