...
import (
	...
	initializationv1alpha1 "github.com/kcp-dev/init-agent/sdk/clientset/versioned/cluster/typed/initialization/v1alpha1"
)

type ClusterInterface interface {
	Cluster(logicalcluster.Path) client.Interface
	Discovery() discovery.DiscoveryInterface
	InitializationV1alpha1() initializationv1alpha1.InitializationV1alpha1ClusterInterface
}
...
type ClusterClientset struct {
	*discovery.DiscoveryClient
	...
	initializationV1alpha1 *initializationv1alpha1.InitializationV1alpha1ClusterClient
}
...
func (c *ClusterClientset) InitializationV1alpha1() initializationv1alpha1.InitializationV1alpha1ClusterInterface {
	return c.initializationV1alpha1
}
