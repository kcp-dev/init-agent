...
// InitTemplateApplyConfiguration represents a declarative configuration of the InitTemplate type for use
// with apply.
...
// InitTemplate constructs a declarative configuration of the InitTemplate type for use with
// apply.
func InitTemplate(name string) *InitTemplateApplyConfiguration {
	b := &InitTemplateApplyConfiguration{}
	b.WithName(name)
	b.WithKind("InitTemplate")
	b.WithAPIVersion("initialization.kcp.io/v1alpha1")
	return b
}
...
func (b *InitTemplateApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
