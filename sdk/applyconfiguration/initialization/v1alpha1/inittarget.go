...
// InitTargetApplyConfiguration represents a declarative configuration of the InitTarget type for use
// with apply.
...
// InitTarget constructs a declarative configuration of the InitTarget type for use with
// apply.
func InitTarget(name string) *InitTargetApplyConfiguration {
	b := &InitTargetApplyConfiguration{}
	b.WithName(name)
	b.WithKind("InitTarget")
...
func (b *InitTargetApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
